                    ...
                    for item in otps_list:
                        ...
                        if phone in api_number or api_number in phone:
                            ...
                            if otp_code:
                                ...
                                # --- গ্রুপের মেসেজ ফরম্যাট (স্ক্রিনশট অনুযায়ী আপডেট করা হলো) ---
                                masked_phone = phone[:4] + "***" + phone[-4:] if len(phone) > 7 else phone
                                group_msg = (
                                    f"🟢 <b>NUMBER OTP GURUP</b>\n\n"
                                    f"📞 Number: <code>{masked_phone}</code>\n"
                                    f"🔑 OTP Code: <code>{otp_code}</code>\n\n"
                                    f"🌐 Country: {country_flag} {country_full_name}\n\n"
                                ...
                                group_payload = {
                                    ...
                                    "parse_mode": "HTML",
                                    "reply_markup": {
                                        "inline_keyboard": [[{"text": "Open Bot", "url": f"https://t.me/{BOT_USERNAME}", "style": "success"}]]
                                    }
                                }
